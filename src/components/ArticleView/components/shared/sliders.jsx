  ...
  return (
    <div className="w-full">
      <TimeSlider.Root className="group relative inline-flex w-full cursor-pointer touch-none select-none items-center outline-none aria-hidden:hidden">
        <TimeSlider.Track className="relative ring-sky-400 z-0 h-2 w-full rounded-full bg-content4 group-data-[focus]:ring-[3px]">
        ...
        <TimeSlider.Thumb className="absolute left-[var(--slider-fill)] top-1/2 z-20 h-[15px] w-[15px] -translate-x-1/2 -translate-y-1/2 rounded-full border shadow-custom bg-white  ring-primary/40 group-data-[dragging]:ring-4 will-change-[left]" />
      </TimeSlider.Root>
